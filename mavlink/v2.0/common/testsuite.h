...
static void mavlink_test_play_tune(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_play_tune_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_play_tune_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.tune );
    mavlink_msg_play_tune_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_play_tune_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.tune );
    mavlink_msg_play_tune_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_play_tune_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_play_tune_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.tune );
    mavlink_msg_play_tune_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_avoidance_triplet(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_AVOIDANCE_TRIPLET >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_avoidance_triplet_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.gen_count = packet_in.gen_count;
        packet1.prev_x = packet_in.prev_x;
        packet1.prev_y = packet_in.prev_y;
        packet1.prev_z = packet_in.prev_z;
        packet1.ctrl_x = packet_in.ctrl_x;
        packet1.ctrl_y = packet_in.ctrl_y;
        packet1.ctrl_z = packet_in.ctrl_z;
        packet1.next_x = packet_in.next_x;
        packet1.next_y = packet_in.next_y;
        packet1.next_z = packet_in.next_z;
        packet1.delta_t = packet_in.delta_t;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_AVOIDANCE_TRIPLET_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_AVOIDANCE_TRIPLET_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_avoidance_triplet_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_avoidance_triplet_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_avoidance_triplet_pack(system_id, component_id, &msg , packet1.time_usec , packet1.gen_count , packet1.prev_x , packet1.prev_y , packet1.prev_z , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z , packet1.next_x , packet1.next_y , packet1.next_z , packet1.delta_t , packet1.max_acc , packet1.acc_per_err );
    mavlink_msg_avoidance_triplet_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_avoidance_triplet_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.gen_count , packet1.prev_x , packet1.prev_y , packet1.prev_z , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z , packet1.next_x , packet1.next_y , packet1.next_z , packet1.delta_t , packet1.max_acc , packet1.acc_per_err );
    mavlink_msg_avoidance_triplet_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_avoidance_triplet_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_avoidance_triplet_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.gen_count , packet1.prev_x , packet1.prev_y , packet1.prev_z , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z , packet1.next_x , packet1.next_y , packet1.next_z , packet1.delta_t , packet1.max_acc , packet1.acc_per_err );
    mavlink_msg_avoidance_triplet_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_avoidance_triplet(system_id, component_id, last_msg);
}
